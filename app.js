...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "s06.p1title": "Meet the people behind an impeccable project",
      "s06.p1spec": "One continuous idea · no interviews · trust as the product",
      "s06.p1lead": "This is a film about the people whose names stand behind every decision: the architect who won’t compromise on materials. The designer for whom an apartment is a life, not a set of rooms. The resident who wakes up every morning in a home that was a promise — and became reality. We introduce you to the people you trust with your money and your years ahead. And we leave the viewer with one thought: “I want to be part of what people like this create.”",
      "s06.p1k1": "No Q&A — one continuous idea",
      "s06.p1k2": "Every voice, one company value",
      "s06.p1k3": "RU / EN / ZH subtitles",
      "s06.p2badge": "Values · voices",
      "s06.p2title": "Five themes that build trust in Gardens of Eden — and who speaks for each one on screen.",
      "s06.p2f1": "Trust and reputation",
      "s06.p2w1": "Narrator — scale, experience, an impeccable track record",
      "s06.p2f2": "Architecture built for decades",
      "s06.p2w2": "Architect Martin Palleros — philosophy, materials that don’t age",
      "s06.p2f3": "The feel of an actual home",
      "s06.p2w3": "Interior designer Patricia Ho Duyen — warmth, detail, the feel of living",
      "s06.p2f4": "The financial logic of the investment",
      "s06.p2w4": "Narrator — the market, the returns, the Laguna Phuket precedent",
      "s06.p2f5": "What living here is really like",
      "s06.p2w5": "The resident — an honest testimony, from the inside",
    ...
    ru: {
      ...
      "s06.p1title": "Познакомьтесь с людьми, создающими безупречный проект",
      "s06.p1spec": "Единая мысль · без интервью · доверие как продукт",
      "s06.p1lead": "Это фильм о людях, чьи имена стоят за каждым решением: архитектор, который не идёт на компромисс с материалом. Дизайнер, для которой квартира — это жизнь, а не набор комнат. Резидент, который каждое утро просыпается в доме, что был обещанием и стал реальностью. Мы знакомим с теми, кому вы доверяете свои деньги и годы вперёд. И оставляем зрителя с одной мыслью: «Я хочу быть частью того, что создают такие люди».",
      "s06.p1k1": "Без вопрос-ответ — единая мысль",
      "s06.p1k2": "Каждый голос — своя ценность компании",
      "s06.p1k3": "Субтитры RU / EN / ZH",
      "s06.p2badge": "Ценности · голоса",
      "s06.p2title": "Пять тем, которые формируют доверие к Gardens of Eden — и кто отвечает за каждую в кадре.",
      "s06.p2f1": "Надёжность и репутация",
      "s06.p2w1": "Рассказчик — масштаб, опыт, безупречная история",
      "s06.p2f2": "Архитектура на десятилетия",
      "s06.p2w2": "Архитектор Мартин Паллерос — философия, материалы, которые не стареют",
      "s06.p2f3": "Атмосфера настоящего дома",
      "s06.p2w3": "Дизайнер интерьеров Патриция Хо Дуен — тепло, деталь, ощущение жизни",
      "s06.p2f4": "Финансовая логика инвестиции",
      "s06.p2w4": "Рассказчик — рынок, доходность, прецедент Laguna Phuket",
      "s06.p2f5": "Жизнь здесь на самом деле",
      "s06.p2w5": "Резидент — честное свидетельство изнутри",
