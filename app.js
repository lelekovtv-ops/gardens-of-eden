...
(function () {
  ...
  var I18N = {
    en: {
      ...
      "s02.p5bio": "A visionary with 20 years in film and video production. He runs complex creative cycles and builds strong teams for international-scale projects. Screenwriter and father of two.",
      "s02.p5s1": "international film festivals",
    ...
    ru: {
      ...
      "s02.p5bio": "Визионер с 20-летним опытом в киноиндустрии и видеопроизводстве. Управляет сложными креативными циклами и создаёт сильные творческие команды для проектов международного уровня. Сценарист и отец двоих детей.",
      "s02.p5s1": "международных кинофестивалей",
